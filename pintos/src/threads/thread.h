...
enum thread_status
  {
    ...
    THREAD_WATING,     /* Waiting for timmer. */
...
struct thread
  {
    ...
    int base_priority;
    int time_slice;
    int64_t wake_tick;   //wake_tick
    struct list_elem allelem;           /* List element for all threads list. */
    struct list_elem wait_elem;         /* List element for waiting threads. */
...
bool thread_wake_comp (const struct list_elem* a,const struct list_elem*b, void* aux);
